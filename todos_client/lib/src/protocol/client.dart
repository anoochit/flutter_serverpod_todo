...
import 'package:todos_client/src/protocol/todo_class.dart' as _i3;
...
class _EndpointTodo extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i3.Todo>?> getTodos(int userId) =>
  ...
  _i2.Future<bool> updateTodoStatus(_i3.Todo todo) =>
